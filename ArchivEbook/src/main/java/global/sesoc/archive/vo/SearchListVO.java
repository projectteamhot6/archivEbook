...
public class SearchListVO {
	...
	public SearchListVO(String title, String link, String image, String author, String price, String discount,
	...
	public String toString() {
		return "SearchListVO [title=" + title + ", link=" + link + ", image=" + image + ", author=" + author
